...
<br> In Chart 1, I wanted to see how much people relied on books for self help. What I found interesting about Chart 2 was that the *Harry Potter* series had an average of `r format (avg_potter)`, Psychology books had a high of `r format (high_book, scientific = FALSE)` while video disks had a high of `r format (high_video, scientific = FALSE)`. The average *Twilight* checkouts were `r format (avg_twilight, scientific = FALSE)`. And the average for *A Song of Ice and Fire* was `r format (avg_twilight, scientific = FALSE)`.
...
<br> In this chart I wanted to see if people were checking these items out in digital format but surprisingly, no psychology book was checked out in ebook format. There was a big spike in checkouts in December of 2017. And looking at the dataset it was actually one specific book that was written by a neurologist before his death. As expected there was a low checkout rate during the early pandemic and then a slight surge around 2021 when places started to open up again. 
